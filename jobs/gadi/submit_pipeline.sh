...
for (( b=0; b<N_BATCHES; b++ )); do
    ...
    VARS="EXPERIMENT_CONFIG=${EXPERIMENT_CONFIG},TOTAL_DATASETS=${TOTAL_DATASETS},CHUNK_SIZE=${CHUNK_SIZE},BATCH_OFFSET=${OFFSET},CONCURRENT_DATASETS=${CONCURRENT_DATASETS},CORES_PER_DATASET=${CORES_PER_DATASET},PARQUET=${PARQUET:-1}"
