...
- Be intelligent, interpretable, concise, direct, targeted, surgical, efficient, and not verbose, unless required. If a complex task can be fully achieved with a simple, interpretable, readable implementation, do so. Do not unnecessarily overcomplicate anything. If the complexity of the task or code is too complex, consider a refactor.
