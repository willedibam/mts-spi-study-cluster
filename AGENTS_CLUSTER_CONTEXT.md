...
- Allocation: Scratch 1 TiB / 202k inodes; gdata 100 GiB / 70k inodes. Live 2026-09-24 checkpoint: Scratch 211.86 GiB / 148,322 inodes (73.4%); gdata 35.84 GiB / 61,086 (87.3%). These are project-wide totals. Baseten grew from 84 to 38,844 entries between earlier audit checkpoints and was not modified by the MTS cleanup. Check current byte and inode quotas before large runs. See the [storage audit](docs/operations/gadi-storage-audit-260922.md).
...
- Proof/case refresh on 2026-09-24: Gadi main checkout `247b9e1`, pyspi `65317c9`, both clean at deployment. Both 350-dataset focused cases completed; proof farms and dependent stochastic replay/figure jobs are submitted. See `results/cases/refresh-260924-execution.json`. Notebook execution dependencies were added without changing existing package versions; inventories live in the proof refresh analysis folder.
...
- `nci_account` reports the spendable quarterly allocation. Live 2026.q3 balance on 2026-09-24: 124.51 KSU granted, 85.78 KSU used, 35.56 KSU available, 3.17 KSU reserved. The grant can change; query again before submission.
