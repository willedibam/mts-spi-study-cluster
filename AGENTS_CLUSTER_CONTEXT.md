...
- Allocation: Scratch 1 TiB / 202k inodes; gdata 100 GiB / 70k inodes. Final 2026-09-23 checkpoint: Scratch 180.62 GiB / 155,063 inodes (76.8%); gdata 35.84 GiB / 61,080 (87.3%). These are project-wide totals. Baseten grew from 84 to 38,844 entries between audit checkpoints and was not modified by the MTS cleanup. Check current byte and inode quotas before large runs. See the [storage audit](docs/operations/gadi-storage-audit-260922.md).
